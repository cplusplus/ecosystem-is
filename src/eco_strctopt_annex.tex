...
\infannex{strctoptjschm}{Structured Options JSON Schema}

\rSec1[strctoptjschm.general]{General}

\pnum
This Annex defines the structured options capability schema
\iref{strctopt.schema} in terms of a \emph{JSON Schema}.
...
\rSec1[strctoptjschm.spec]{JSON Schema Specification}
